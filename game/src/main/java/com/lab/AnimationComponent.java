...
public class AnimationComponent extends Component{
    ...
    public AnimationComponent() {
        animIdleD = new AnimationChannel(FXGL.image("idle_down.png"), 8, 48, 64, Duration.seconds(1), 0, 7); // กำหนดเฟรมของIdel
        ...
        animWalkLeft = new AnimationChannel(FXGL.image("walk_left_down.png"), 8, 48, 64, Duration.seconds(0.5), 0, 7); // กำหนดเฟรมของWalk
